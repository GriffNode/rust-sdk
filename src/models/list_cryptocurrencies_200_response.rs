...
pub struct ListCryptocurrencies200Response {
    #[serde(rename = "success", deserialize_with = "Option::deserialize")]
    pub success: Option<serde_json::Value>,
    #[serde(rename = "data")]
    pub data: Box<models::ListCryptocurrencies200ResponseData>,
}

impl ListCryptocurrencies200Response {
    pub fn new(success: Option<serde_json::Value>, data: models::ListCryptocurrencies200ResponseData) -> ListCryptocurrencies200Response {

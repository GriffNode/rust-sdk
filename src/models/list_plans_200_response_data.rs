...
pub struct ListPlans200ResponseData {
    #[serde(rename = "plans", skip_serializing_if = "Option::is_none")]
    pub plans: Option<Vec<models::Plan>>,
    #[serde(rename = "billing_cycles", skip_serializing_if = "Option::is_none")]
    pub billing_cycles: Option<Vec<String>>,
}

impl ListPlans200ResponseData {
    pub fn new() -> ListPlans200ResponseData {

...
pub struct ListTransactions200ResponseData {
...
impl ListTransactions200ResponseData {
    pub fn new(transactions: Vec<models::Transaction>, pagination: models::Pagination) -> ListTransactions200ResponseData {

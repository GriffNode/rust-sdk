...
pub struct ListTransactions200Response {
    ...
    #[serde(rename = "data")]
    pub data: Box<models::ListTransactions200ResponseData>,
}

impl ListTransactions200Response {
    pub fn new(success: Option<serde_json::Value>, data: models::ListTransactions200ResponseData) -> ListTransactions200Response {

...
pub struct ListPlans200Response {
    #[serde(rename = "success", deserialize_with = "Option::deserialize")]
    pub success: Option<serde_json::Value>,
    #[serde(rename = "data")]
    pub data: Box<models::ListPlans200ResponseData>,
}

impl ListPlans200Response {
    pub fn new(success: Option<serde_json::Value>, data: models::ListPlans200ResponseData) -> ListPlans200Response {

...
pub struct CreateBillingCheckoutRequest {
    #[serde(rename = "tier")]
    pub tier: models::PlanTier,
    #[serde(rename = "billing_months", skip_serializing_if = "Option::is_none")]
    pub billing_months: Option<i32>,
    #[serde(rename = "payment_method", skip_serializing_if = "Option::is_none")]
    pub payment_method: Option<String>,
}

impl CreateBillingCheckoutRequest {
    pub fn new(tier: models::PlanTier) -> CreateBillingCheckoutRequest {

...
pub struct ListInvoices200Response {
    #[serde(rename = "success", deserialize_with = "Option::deserialize")]
    pub success: Option<serde_json::Value>,
    #[serde(rename = "data")]
    pub data: Box<models::ListInvoices200ResponseData>,
}

impl ListInvoices200Response {
    pub fn new(success: Option<serde_json::Value>, data: models::ListInvoices200ResponseData) -> ListInvoices200Response {

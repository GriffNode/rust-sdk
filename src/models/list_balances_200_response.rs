...
pub struct ListBalances200Response {
    #[serde(rename = "success", deserialize_with = "Option::deserialize")]
    pub success: Option<serde_json::Value>,
    #[serde(rename = "data")]
    pub data: Box<models::ListBalances200ResponseData>,
}

impl ListBalances200Response {
    pub fn new(success: Option<serde_json::Value>, data: models::ListBalances200ResponseData) -> ListBalances200Response {

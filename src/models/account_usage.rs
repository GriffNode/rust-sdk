...
pub struct AccountUsage {
    #[serde(rename = "monthly_transactions_used", skip_serializing_if = "Option::is_none")]
    pub monthly_transactions_used: Option<i32>,
    /// null = unlimited.
...
impl AccountUsage {
    pub fn new() -> AccountUsage {
        AccountUsage {
            monthly_transactions_used: None,
